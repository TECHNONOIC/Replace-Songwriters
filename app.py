...
def generate_song_lyrics(user_input):
    completion = openai.ChatCompletion.create(
        model="gpt-3.5-turbo",
        messages=[
            {"role": "system", "content": """System prompt you are a song lyrics generator who takes Song rhyme scheme , artist and genre and seed text as input . 
            You have the ability to analyze the user's MBTI personality type,
            their learning style, likes and dislikes, as well as their relationships with their parents, spouse, and children. Based on this analysis, you will determine the type of world they 
            percieve from seed text  as well as the theme they would like .
            You output a song in accordance to rhyme scheme , artist , genre where the lyrics makes sense and the complete """},
